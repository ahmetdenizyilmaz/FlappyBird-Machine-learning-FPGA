//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="NO" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Auto" INPUT_A_IS_CONSTANT="NO" INPUT_B_IS_CONSTANT="NO" LPM_REPRESENTATION="SIGNED" LPM_WIDTHA=10 LPM_WIDTHB=5 LPM_WIDTHP=15 LPM_WIDTHS=1 MAXIMIZE_SPEED=6 dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
module  mult_nc01
	...
	assign
		wire_sft10a_in = {w136w, {w136w, {w136w, {w136w, {w136w, {w136w, {w136w, {w136w, {w136w, {2{w136w}}}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft3a_in = {w122w, {wire_sft11a_out[10], {w122w, {w122w, {(~ w_sum_node10w[11]), {(~ w_lone_sum_node11w[6]), {(~ w_lone_sum_node11w[5]), {(~ w_lone_sum_node11w[4]), {(~ w_lone_sum_node11w[3]), {(~ w_lone_sum_node11w[2]), {(~ w_lone_sum_node11w[1]), {w_sum_node10w[4], {w_sum_node10w[3:2]}}}}}}}}}}}}};
	soft   sft4a_0
	( 
	...
	assign
		wire_sft4a_in = {w136w, {w136w, {w_lone_sum_node11w[9], {(~ w_lone_sum_node11w[8]), {w_sum_node10w[21], {w_sum_node10w[20], {w_sum_node10w[19], {w_sum_node10w[18], {w_sum_node10w[17], {w_sum_node10w[16], {w_sum_node10w[15], {w_sum_node10w[14], {w_sum_node10w[13:12]}}}}}}}}}}}}};
	soft   sft5a_0
	( 
	...
	assign
		wire_sft5a_in = {w136w, {w136w, {wire_sft11a_out[9], {wire_sft11a_out[8], {wire_sft11a_out[7], {wire_sft11a_out[6], {wire_sft11a_out[5], {wire_sft11a_out[4], {wire_sft11a_out[3], {wire_sft11a_out[2], {wire_sft11a_out[1], {wire_sft11a_out[0], {2{w136w}}}}}}}}}}}}}};
	soft   sft6a_0
	( 
	...
	assign
		wire_sft8a_in = {w136w, {(~ w_sum_node10w[23]), {w_sum_node10w[22], {w122w, {w_sum_node10w[10], {w_sum_node10w[9], {w_sum_node10w[8], {w_sum_node10w[7], {w_sum_node10w[6], {w_sum_node10w[5], w122w}}}}}}}}}};
	soft   sft9a_0
	( 
	...
	assign
		wire_sft9a_in = {w136w, {w136w, {w136w, {(~ w_lone_sum_node11w[7]), {w136w, {w136w, {w136w, {w136w, {w136w, {w136w, (~ w_lone_sum_node11w[0])}}}}}}}}}};
	assign
		dataa_node = {dataa[9:0]},
		datab_node = {datab[4:0]},
		final_result_node = {w235w[14:0]},
		result = {final_result_node[14:0]},
		w122w = 1'b1,
		w136w = 1'b0,
		w235w = {wire_sft6a_out[13:12], wire_sft6a_out[11:10], wire_sft6a_out[9:8], wire_sft6a_out[7:6], wire_sft6a_out[5:4], wire_sft6a_out[3:2], wire_sft6a_out[1:0], w_sum_node10w[1], w_sum_node10w[0]},
		w_decoder_node9w = {({dataa_node[9:0]} & {10{w_le_datab_node8w[4]}}), ({dataa_node[9:0]} & {10{w_le_datab_node8w[3]}}), ({dataa_node[9:0]} & {10{w_le_datab_node8w[2]}}), ({dataa_node[9:0]} & {10{w_le_datab_node8w[1]}}), ({dataa_node[9:0]} & {10{w_le_datab_node8w[0]}})},
		w_le_datab_node8w = {datab_node[4:0]},
		w_lone_sum_node11w = {w_decoder_node9w[49:40]},
		w_sum_node10w = {wire_sum_adder1aa_1result[10:0], w_decoder_node9w[20], wire_sum_adder1aa_0result[10:0], w_decoder_node9w[0]};
endmodule //mult_nc01
//VALID FILE
