//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="NO" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Auto" INPUT_A_IS_CONSTANT="NO" INPUT_B_IS_CONSTANT="NO" LPM_REPRESENTATION="SIGNED" LPM_WIDTHA=14 LPM_WIDTHB=14 LPM_WIDTHP=28 LPM_WIDTHS=1 MAXIMIZE_SPEED=6 dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
module  mult_fe01
	...
	wire	[15:0]	wire_sum_adder1aa_6result_int;
	...
	assign
		wire_sum_adder1aa_5dataa = {w_decoder_node9w[167], w_decoder_node9w[167:154]},
		wire_sum_adder1aa_5datab = {{2{w_decoder_node9w[153]}}, w_decoder_node9w[153:141]};
	assign
	...
	assign
		wire_sum_adder1aa_6result = wire_sum_adder1aa_6result_int[15:1];
	assign
		wire_sum_adder1aa_6cin = 1'b1,
		wire_sum_adder1aa_6dataa = {(~ w_decoder_node9w[195]), (~ w_decoder_node9w[195:182])},
		wire_sum_adder1aa_6datab = {{2{w_decoder_node9w[181]}}, w_decoder_node9w[181:169]};
	soft   sft10a_0
	( 
	...
	assign
		wire_sft10a_in = {w343w, {w343w, {w343w, {w343w, {(~ w_sum_node10w[63]), {w330w, {w_sum_node10w[103], {w_sum_node10w[102], {w_sum_node10w[87], {w_sum_node10w[86], {w_sum_node10w[71], {w_sum_node10w[70], {w_sum_node10w[69], {w_sum_node10w[68], {w_sum_node10w[67], {w_sum_node10w[66], {w_sum_node10w[65], {w_sum_node10w[64], {2{w343w}}}}}}}}}}}}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft13a_in = {w343w, {w_sum_node10w[62], {(~ w_sum_node10w[47]), {w330w, {w_sum_node10w[101], {w_sum_node10w[100], {w_sum_node10w[85], {w_sum_node10w[84], {w_sum_node10w[83], {w_sum_node10w[82], {w_sum_node10w[81:80]}}}}}}}}}}};
	soft   sft14a_0
	( 
	...
	assign
		wire_sft14a_in = {w343w, {w343w, {w343w, {w_sum_node10w[60], {w_sum_node10w[45], {w_sum_node10w[44], {w_sum_node10w[29], {w_sum_node10w[28], {w_sum_node10w[27], {w_sum_node10w[26], {w_sum_node10w[25:24]}}}}}}}}}}};
	soft   sft15a_0
	( 
	...
	assign
		wire_sft15a_in = {w343w, {w343w, {w343w, {w343w, {(~ w_sum_node10w[31]), {w330w, {w_sum_node10w[99], {w_sum_node10w[98], {w_sum_node10w[97], {w_sum_node10w[96], {2{w343w}}}}}}}}}}}};
	soft   sft16a_0
	( 
	...
	assign
		wire_sft18a_in = {w343w, {w_sum_node10w[30], w330w}};
	soft   sft19a_0
	( 
	...
	assign
		wire_sft19a_in = {w343w, {w343w, (~ w_sum_node10w[15])}};
	soft   sft20a_0
	( 
	...
	assign
		wire_sft3a_in = {w330w, {(~ w_sum_node10w[111]), {w_sum_node10w[110], {(~ w_sum_node10w[95]), {w330w, {w_sum_node10w[107], {w_sum_node10w[78], {w_sum_node10w[77], {w_sum_node10w[76], {w_sum_node10w[61], {w_sum_node10w[46], {wire_sft11a_out[11], {wire_sft11a_out[10], {wire_sft11a_out[9], {w_sum_node10w[14], {w_sum_node10w[13], {w_sum_node10w[12], {w_sum_node10w[11], {w_sum_node10w[10], {w_sum_node10w[9], {w_sum_node10w[8], {w_sum_node10w[7], {w_sum_node10w[6], {w_sum_node10w[5], {w_sum_node10w[4], {w_sum_node10w[3:2]}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft4a_0
	( 
	...
	assign
		wire_sft4a_in = {w343w, {w343w, {w330w, {w_sum_node10w[109], {w_sum_node10w[108], {w_sum_node10w[93], {w_sum_node10w[92], {wire_sft11a_out[15], {wire_sft11a_out[14], {wire_sft11a_out[13], {wire_sft11a_out[12], {wire_sft16a_out[7], {wire_sft16a_out[6], {wire_sft16a_out[5], {wire_sft11a_out[8], {wire_sft11a_out[7], {wire_sft11a_out[6], {wire_sft11a_out[5], {wire_sft11a_out[4], {w_sum_node10w[23], {w_sum_node10w[22], {w_sum_node10w[21], {w_sum_node10w[20], {w_sum_node10w[19], {w_sum_node10w[18], {w_sum_node10w[17:16]}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft5a_0
	( 
	...
	assign
		wire_sft5a_in = {w343w, {w343w, {w343w, {wire_sft11a_out[19], {wire_sft11a_out[18], {wire_sft11a_out[17], {wire_sft11a_out[16], {wire_sft16a_out[11], {wire_sft16a_out[10], {wire_sft16a_out[9], {wire_sft16a_out[8], {wire_sft21a_out[2], {wire_sft21a_out[1], {wire_sft21a_out[0], {wire_sft16a_out[4], {wire_sft16a_out[3], {wire_sft16a_out[2], {wire_sft16a_out[1], {wire_sft16a_out[0], {wire_sft11a_out[3], {wire_sft11a_out[2], {wire_sft11a_out[1], {wire_sft11a_out[0], {w_sum_node10w[33], {w_sum_node10w[32], {2{w343w}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft6a_0
	( 
	...
	assign
		wire_sft8a_in = {w343w, {w_sum_node10w[94], {(~ w_sum_node10w[79]), {w330w, {w_sum_node10w[105], {w_sum_node10w[104], {w_sum_node10w[89], {w_sum_node10w[88], {w_sum_node10w[73], {w_sum_node10w[72], {w_sum_node10w[57], {w_sum_node10w[56], {w_sum_node10w[55], {w_sum_node10w[54], {w_sum_node10w[53], {w_sum_node10w[52], {w_sum_node10w[51], {w_sum_node10w[50], {w_sum_node10w[49:48]}}}}}}}}}}}}}}}}}}};
	soft   sft9a_0
	( 
	...
	assign
		wire_sft9a_in = {w343w, {w343w, {w343w, {w_sum_node10w[106], {w_sum_node10w[91], {w_sum_node10w[90], {w_sum_node10w[75], {w_sum_node10w[74], {w_sum_node10w[59], {w_sum_node10w[58], {w_sum_node10w[43], {w_sum_node10w[42], {w_sum_node10w[41], {w_sum_node10w[40], {w_sum_node10w[39], {w_sum_node10w[38], {w_sum_node10w[37], {w_sum_node10w[36], {w_sum_node10w[35:34]}}}}}}}}}}}}}}}}}}};
	assign
		dataa_node = {dataa[13:0]},
		datab_node = {datab[13:0]},
		final_result_node = {w588w[27:0]},
