//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="NO" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Auto" INPUT_A_IS_CONSTANT="NO" INPUT_B_IS_CONSTANT="NO" LPM_REPRESENTATION="SIGNED" LPM_WIDTHA=18 LPM_WIDTHB=19 LPM_WIDTHP=37 LPM_WIDTHS=1 MAXIMIZE_SPEED=5 dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
//lpm_add_sub CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48 CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEVICE_FAMILY="Cyclone V" LPM_REPRESENTATION="SIGNED" LPM_WIDTH=20 dataa datab result
...
//lpm_add_sub CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48 CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEVICE_FAMILY="Cyclone V" LPM_REPRESENTATION="SIGNED" LPM_WIDTH=20 cin dataa datab result
//VERSION_BEGIN 14.1 cbx_cycloneii 2014:12:03:18:04:04:SJ cbx_lpm_add_sub 2014:12:03:18:04:04:SJ cbx_mgl 2014:12:03:18:06:09:SJ cbx_stratix 2014:12:03:18:04:04:SJ cbx_stratixii 2014:12:03:18:04:04:SJ  VERSION_END
...
module  mult_ne01
	...
	wire	[20:0]	wire_add12_result;
	wire	[12:0]	wire_add17_result;
	wire	[35:0]	wire_add2_result;
	wire	[2:0]	wire_add22_result;
	wire	[28:0]	wire_add7_result;
	...
	wire	[19:0]	wire_sum_adder1aa_4dataa;
	wire	[19:0]	wire_sum_adder1aa_4datab;
	wire	[19:0]	wire_sum_adder1aa_4result;
	wire	[19:0]	wire_sum_adder1aa_5dataa;
	wire	[19:0]	wire_sum_adder1aa_5datab;
	wire	[19:0]	wire_sum_adder1aa_5result;
	wire	[19:0]	wire_sum_adder1aa_6dataa;
	wire	[19:0]	wire_sum_adder1aa_6datab;
	wire	[19:0]	wire_sum_adder1aa_6result;
	wire	[19:0]	wire_sum_adder1aa_7dataa;
	wire	[19:0]	wire_sum_adder1aa_7datab;
	wire	[19:0]	wire_sum_adder1aa_7result;
	wire	[20:0]	wire_sum_adder1aa_8result_int;
	wire	wire_sum_adder1aa_8cin;
	wire	[19:0]	wire_sum_adder1aa_8dataa;
	wire	[19:0]	wire_sum_adder1aa_8datab;
	wire	[19:0]	wire_sum_adder1aa_8result;
	wire  [28:0]   wire_sft10a_in;
	wire  [28:0]   wire_sft10a_out;
	wire  [28:0]   wire_sft11a_in;
	wire  [28:0]   wire_sft11a_out;
	wire  [20:0]   wire_sft13a_in;
	wire  [20:0]   wire_sft13a_out;
	wire  [20:0]   wire_sft14a_in;
	wire  [20:0]   wire_sft14a_out;
	wire  [20:0]   wire_sft15a_in;
	wire  [20:0]   wire_sft15a_out;
	wire  [20:0]   wire_sft16a_in;
	wire  [20:0]   wire_sft16a_out;
	wire  [12:0]   wire_sft18a_in;
	wire  [12:0]   wire_sft18a_out;
	wire  [12:0]   wire_sft19a_in;
	wire  [12:0]   wire_sft19a_out;
	wire  [12:0]   wire_sft20a_in;
	wire  [12:0]   wire_sft20a_out;
	wire  [12:0]   wire_sft21a_in;
	wire  [12:0]   wire_sft21a_out;
	...
	wire  [28:0]   wire_sft8a_in;
	wire  [28:0]   wire_sft8a_out;
	wire  [28:0]   wire_sft9a_in;
	wire  [28:0]   wire_sft9a_out;
	...
	wire  w502w;
	wire  [37:0]  w906w;
	wire  [341:0]  w_decoder_node9w;
	wire  [17:0]  w_le_datab_node8w;
	wire  [188:0]  w_sum_node10w;
	...
	assign
		wire_sum_adder1aa_0dataa = {w_decoder_node9w[37], w_decoder_node9w[37:19]},
		wire_sum_adder1aa_0datab = {{2{w_decoder_node9w[18]}}, w_decoder_node9w[18:1]};
	assign
		wire_sum_adder1aa_1result = wire_sum_adder1aa_1dataa + wire_sum_adder1aa_1datab;
	assign
		wire_sum_adder1aa_1dataa = {w_decoder_node9w[75], w_decoder_node9w[75:57]},
		wire_sum_adder1aa_1datab = {{2{w_decoder_node9w[56]}}, w_decoder_node9w[56:39]};
	assign
		wire_sum_adder1aa_2result = wire_sum_adder1aa_2dataa + wire_sum_adder1aa_2datab;
	assign
		wire_sum_adder1aa_2dataa = {w_decoder_node9w[113], w_decoder_node9w[113:95]},
		wire_sum_adder1aa_2datab = {{2{w_decoder_node9w[94]}}, w_decoder_node9w[94:77]};
	assign
		wire_sum_adder1aa_3result = wire_sum_adder1aa_3dataa + wire_sum_adder1aa_3datab;
	assign
		wire_sum_adder1aa_3dataa = {w_decoder_node9w[151], w_decoder_node9w[151:133]},
		wire_sum_adder1aa_3datab = {{2{w_decoder_node9w[132]}}, w_decoder_node9w[132:115]};
	assign
		wire_sum_adder1aa_4result = wire_sum_adder1aa_4dataa + wire_sum_adder1aa_4datab;
	assign
		wire_sum_adder1aa_4dataa = {w_decoder_node9w[189], w_decoder_node9w[189:171]},
		wire_sum_adder1aa_4datab = {{2{w_decoder_node9w[170]}}, w_decoder_node9w[170:153]};
	assign
		wire_sum_adder1aa_5result = wire_sum_adder1aa_5dataa + wire_sum_adder1aa_5datab;
	assign
		wire_sum_adder1aa_5dataa = {w_decoder_node9w[227], w_decoder_node9w[227:209]},
		wire_sum_adder1aa_5datab = {{2{w_decoder_node9w[208]}}, w_decoder_node9w[208:191]};
	assign
		wire_sum_adder1aa_6result = wire_sum_adder1aa_6dataa + wire_sum_adder1aa_6datab;
	assign
		wire_sum_adder1aa_6dataa = {w_decoder_node9w[265], w_decoder_node9w[265:247]},
		wire_sum_adder1aa_6datab = {{2{w_decoder_node9w[246]}}, w_decoder_node9w[246:229]};
	assign
		wire_sum_adder1aa_7result = wire_sum_adder1aa_7dataa + wire_sum_adder1aa_7datab;
	assign
		wire_sum_adder1aa_7dataa = {w_decoder_node9w[303], w_decoder_node9w[303:285]},
		wire_sum_adder1aa_7datab = {{2{w_decoder_node9w[284]}}, w_decoder_node9w[284:267]};
	assign
	...
	assign
		wire_sum_adder1aa_8result = wire_sum_adder1aa_8result_int[20:1];
	assign
		wire_sum_adder1aa_8cin = 1'b1,
		wire_sum_adder1aa_8dataa = {(~ w_decoder_node9w[341]), (~ w_decoder_node9w[341:323])},
		wire_sum_adder1aa_8datab = {{2{w_decoder_node9w[322]}}, w_decoder_node9w[322:305]};
	soft   sft10a_0
	( 
	...
	assign
		wire_sft10a_in = {w502w, {w502w, {w502w, {w502w, {(~ w_sum_node10w[125]), {w485w, {w_sum_node10w[180], {w_sum_node10w[179], {w_sum_node10w[159], {w_sum_node10w[158], {w_sum_node10w[138], {w_sum_node10w[137], {wire_sft26a_out[2], {wire_sft26a_out[1], {wire_sft26a_out[0], {w_sum_node10w[95], {w_sum_node10w[94], {w_sum_node10w[93], {w_sum_node10w[92], {w_sum_node10w[91], {w_sum_node10w[90], {w_sum_node10w[89], {w_sum_node10w[88], {w_sum_node10w[87], {w_sum_node10w[86], {w_sum_node10w[85], {w_sum_node10w[84], {2{w502w}}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft13a_in = {w502w, {w_sum_node10w[124], {(~ w_sum_node10w[104]), {w485w, {w_sum_node10w[178], {w_sum_node10w[177], {w_sum_node10w[157], {w_sum_node10w[156], {w_sum_node10w[136], {w_sum_node10w[135], {w_sum_node10w[115], {w_sum_node10w[114], {w_sum_node10w[113], {w_sum_node10w[112], {w_sum_node10w[111], {w_sum_node10w[110], {w_sum_node10w[109], {w_sum_node10w[108], {w_sum_node10w[107], {w_sum_node10w[106:105]}}}}}}}}}}}}}}}}}}}};
	soft   sft14a_0
	( 
	...
	assign
		wire_sft14a_in = {w502w, {w502w, {w502w, {w_sum_node10w[122], {w_sum_node10w[102], {w_sum_node10w[101], {w_sum_node10w[81], {w_sum_node10w[80], {w_sum_node10w[60], {w_sum_node10w[59], {w_sum_node10w[39], {w_sum_node10w[38], {w_sum_node10w[37], {w_sum_node10w[36], {w_sum_node10w[35], {w_sum_node10w[34], {w_sum_node10w[33], {w_sum_node10w[32], {w_sum_node10w[31], {w_sum_node10w[30:29]}}}}}}}}}}}}}}}}}}}};
	soft   sft15a_0
	( 
	...
	assign
		wire_sft15a_in = {w502w, {w502w, {w502w, {w502w, {(~ w_sum_node10w[83]), {w485w, {w_sum_node10w[176], {w_sum_node10w[175], {w_sum_node10w[155], {w_sum_node10w[154], {w_sum_node10w[134], {w_sum_node10w[133], {w_sum_node10w[132], {w_sum_node10w[131], {w_sum_node10w[130], {w_sum_node10w[129], {w_sum_node10w[128], {w_sum_node10w[127], {w_sum_node10w[126], {2{w502w}}}}}}}}}}}}}}}}}}}}};
	soft   sft16a_0
	( 
	...
	assign
		wire_sft18a_in = {w502w, {w_sum_node10w[82], {(~ w_sum_node10w[62]), {w485w, {w_sum_node10w[174], {w_sum_node10w[173], {w_sum_node10w[153], {w_sum_node10w[152], {w_sum_node10w[151], {w_sum_node10w[150], {w_sum_node10w[149], {w_sum_node10w[148:147]}}}}}}}}}}}};
	soft   sft19a_0
	( 
	...
	assign
		wire_sft19a_in = {w502w, {w502w, {w502w, {w_sum_node10w[61], {(~ w_sum_node10w[41]), {w_sum_node10w[40], {(~ w_sum_node10w[20]), {w_sum_node10w[19], {w_sum_node10w[18], {w_sum_node10w[17], {w_sum_node10w[16], {w_sum_node10w[15:14]}}}}}}}}}}}};
	soft   sft20a_0
	( 
	...
	assign
		wire_sft20a_in = {w502w, {w502w, {w502w, {w502w, {w_sum_node10w[98], {w485w, {w_sum_node10w[172], {w_sum_node10w[171], {w_sum_node10w[170], {w_sum_node10w[169], {w_sum_node10w[168], {2{w502w}}}}}}}}}}}}};
	soft   sft21a_0
	( 
	...
	assign
		wire_sft23a_in = {w502w, {w_sum_node10w[97], w485w}};
	soft   sft24a_0
	( 
	...
	assign
		wire_sft24a_in = {w502w, {w502w, w_sum_node10w[96]}};
	soft   sft25a_0
	( 
	...
	assign
		wire_sft4a_in = {w502w, {w502w, {w485w, {w_sum_node10w[186], {w_sum_node10w[185], {w_sum_node10w[165], {w_sum_node10w[164], {wire_sft11a_out[24], {wire_sft11a_out[23], {wire_sft11a_out[22], {wire_sft11a_out[21], {wire_sft16a_out[16], {wire_sft16a_out[15], {wire_sft16a_out[14], {wire_sft16a_out[13], {wire_sft16a_out[12], {wire_sft16a_out[11], {wire_sft16a_out[10], {wire_sft16a_out[9], {wire_sft16a_out[8], {wire_sft16a_out[7], {wire_sft16a_out[6], {wire_sft16a_out[5], {wire_sft16a_out[4], {wire_sft11a_out[7], {wire_sft11a_out[6], {wire_sft11a_out[5], {wire_sft11a_out[4], {w_sum_node10w[28], {w_sum_node10w[27], {w_sum_node10w[26], {w_sum_node10w[25], {w_sum_node10w[24], {w_sum_node10w[23], {w_sum_node10w[22:21]}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft5a_0
	( 
	...
	assign
		wire_sft5a_in = {w502w, {w502w, {w502w, {wire_sft11a_out[28], {wire_sft11a_out[27], {wire_sft11a_out[26], {wire_sft11a_out[25], {wire_sft16a_out[20], {wire_sft16a_out[19], {wire_sft16a_out[18], {wire_sft16a_out[17], {wire_sft21a_out[12], {wire_sft21a_out[11], {wire_sft21a_out[10], {wire_sft21a_out[9], {wire_sft21a_out[8], {wire_sft21a_out[7], {wire_sft21a_out[6], {wire_sft21a_out[5], {wire_sft21a_out[4], {wire_sft21a_out[3], {wire_sft21a_out[2], {wire_sft21a_out[1], {wire_sft21a_out[0], {wire_sft16a_out[3], {wire_sft16a_out[2], {wire_sft16a_out[1], {wire_sft16a_out[0], {wire_sft11a_out[3], {wire_sft11a_out[2], {wire_sft11a_out[1], {wire_sft11a_out[0], {w_sum_node10w[43], {w_sum_node10w[42], {2{w502w}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft6a_0
	( 
	...
	assign
		wire_sft8a_in = {w502w, {w_sum_node10w[166], {(~ w_sum_node10w[146]), {w485w, {w_sum_node10w[182], {w_sum_node10w[181], {w_sum_node10w[161], {w_sum_node10w[160], {w_sum_node10w[140], {w_sum_node10w[139], {w_sum_node10w[119], {w_sum_node10w[118], {w_sum_node10w[117], {w_sum_node10w[116], {w_sum_node10w[77], {w_sum_node10w[76], {w_sum_node10w[75], {w_sum_node10w[74], {w_sum_node10w[73], {w_sum_node10w[72], {w_sum_node10w[71], {w_sum_node10w[70], {w_sum_node10w[69], {w_sum_node10w[68], {w_sum_node10w[67], {w_sum_node10w[66], {w_sum_node10w[65], {w_sum_node10w[64:63]}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft9a_0
	( 
	...
	assign
		wire_sft9a_in = {w502w, {w502w, {w502w, {w_sum_node10w[183], {w_sum_node10w[163], {w_sum_node10w[162], {w_sum_node10w[142], {w_sum_node10w[141], {w_sum_node10w[121], {w_sum_node10w[120], {w_sum_node10w[100], {w_sum_node10w[99], {w_sum_node10w[79], {w_sum_node10w[78], {w_sum_node10w[58], {w_sum_node10w[57], {w_sum_node10w[56], {w_sum_node10w[55], {w_sum_node10w[54], {w_sum_node10w[53], {w_sum_node10w[52], {w_sum_node10w[51], {w_sum_node10w[50], {w_sum_node10w[49], {w_sum_node10w[48], {w_sum_node10w[47], {w_sum_node10w[46], {w_sum_node10w[45:44]}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	assign
		dataa_node = {datab[18:0]},
		datab_node = {dataa[17:0]},
		final_result_node = {w906w[36:0]},
		result = {final_result_node[36:0]},
		w485w = 1'b1,
		w502w = 1'b0,
		w906w = {wire_sft6a_out[35:34], wire_sft6a_out[33:32], wire_sft6a_out[31:30], wire_sft6a_out[29:28], wire_sft6a_out[27:26], wire_sft6a_out[25:24], wire_sft6a_out[23:22], wire_sft6a_out[21:20], wire_sft6a_out[19:18], wire_sft6a_out[17:16], wire_sft6a_out[15:14], wire_sft6a_out[13:12], wire_sft6a_out[11:10], wire_sft6a_out[9:8], wire_sft6a_out[7:6], wire_sft6a_out[5:4], wire_sft6a_out[3:2], wire_sft6a_out[1:0], w_sum_node10w[1], w_sum_node10w[0]},
		w_decoder_node9w = {({dataa_node[18:0]} & {19{w_le_datab_node8w[17]}}), ({dataa_node[18:0]} & {19{w_le_datab_node8w[16]}}), ({dataa_node[18:0]} & {19{w_le_datab_node8w[15]}}), ({dataa_node[18:0]} & {19{w_le_datab_node8w[14]}}), ({dataa_node[18:0]} & {19{w_le_datab_node8w[13]}}), ({dataa_node[18:0]} & {19{w_le_datab_node8w[12]}}), ({dataa_node[18:0]} & {19{w_le_datab_node8w[11]}}), ({dataa_node[18:0]} & {19{w_le_datab_node8w[10]}}), ({dataa_node[18:0]} & {19{w_le_datab_node8w[9]}}), ({dataa_node[18:0]} & {19{w_le_datab_node8w[8]}}), ({dataa_node[18:0]} & {19{w_le_datab_node8w[7]}}), ({dataa_node[18:0]} & {19{w_le_datab_node8w[6]}}), ({dataa_node[18:0]} & {19{w_le_datab_node8w[5]}}), ({dataa_node[18:0]} & {19{w_le_datab_node8w[4]}}), ({dataa_node[18:0]} & {19{w_le_datab_node8w[3]}}), ({dataa_node[18:0]} & {19{w_le_datab_node8w[2]}}), ({dataa_node[18:0]} & {19{w_le_datab_node8w[1]}}), ({dataa_node[18:0]} & {19{w_le_datab_node8w[0]}})},
		w_le_datab_node8w = {datab_node[17:0]},
		w_sum_node10w = {wire_sum_adder1aa_8result[19:0], w_decoder_node9w[304], wire_sum_adder1aa_7result[19:0], w_decoder_node9w[266], wire_sum_adder1aa_6result[19:0], w_decoder_node9w[228], wire_sum_adder1aa_5result[19:0], w_decoder_node9w[190], wire_sum_adder1aa_4result[19:0], w_decoder_node9w[152], wire_sum_adder1aa_3result[19:0], w_decoder_node9w[114], wire_sum_adder1aa_2result[19:0], w_decoder_node9w[76], wire_sum_adder1aa_1result[19:0], w_decoder_node9w[38], wire_sum_adder1aa_0result[19:0], w_decoder_node9w[0]};
endmodule //mult_ne01
//VALID FILE
